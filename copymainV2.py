...
limit_y_left = 0.03  # valid is higher (+) than this
...
if __name__ == "__main__":
    ...
    # chess.board.set_board_fen('rnbqkbnr/ppp1pppp/8/3pP3/8/8/PPPP1PPP/RNBQKBNR w KQkq - 0 1')
    # chess.board.set_fen('rnbqkbnr/1pppp1pp/p7/4Pp2/8/8/PPPP1PPP/RNBQKBNR w KQkq f6 0 1')
